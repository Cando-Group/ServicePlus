...
<!-- Mirrored from demos.adminmart.com/premium/bootstrap/Accueilize-bootstrap/package/html/main/authentication-two-steps2.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 29 May 2023 16:38:56 GMT -->
<head>
    <!--  Title -->
            ...
            <div class="col-md-8 col-lg-6 col-xxl-3">
              <div class="card mb-0">
                <div class="card-body pt-5">
                  <a href="index.php" class="text-nowrap w-100 logo-img text-center d-block mb-4">
